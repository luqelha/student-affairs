...
<div class="quick-actions">
    ...
    <div class="action-grid">
        <a href="{{ route('admin.beasiswa.index') }}" class="action-btn">
            ...
            <div class="action-text">
                <h4>Kelola Beasiswa</h4>
                <p>Upload & manage</p>
            </div>
        </a>

        <a href="{{ route('admin.prestasi.index') }}" class="action-btn">
            ...
            <div class="action-text">
                <h4>Kelola Prestasi</h4>
                <p>Upload & manage</p>
            </div>
        </a>

        <a href="{{ route('admin.ukm.index') }}" class="action-btn">
